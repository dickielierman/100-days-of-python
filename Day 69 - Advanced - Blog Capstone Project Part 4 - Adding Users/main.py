...
def register():
    ...
    return render_template("register.html", current_user=current_user, current_year=current_year)
...
def login():
    ...
    return render_template("login.html", current_user=current_user, current_year=current_year)
...
@app.route("/contact")
def contact():
    return render_template("contact.html", current_user=current_user, current_year=current_year)
